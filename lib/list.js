...
exports.append = exports.list = exports.is_null = exports.set_tail = exports.set_head = exports.tail = exports.head = exports.pair = void 0;
function pair(hd, tl) {
    return [hd, tl];
}
exports.pair = pair;
...
exports.tail = tail;
function set_head(p, val) {
    p[0] = val;
}
exports.set_head = set_head;
function set_tail(p, val) {
    p[1] = val;
}
