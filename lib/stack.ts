 ...
 * @returns Returns a new stack with the element e on top of the elements of stck.
 */
 ...
 * @returns Returns a stack with all of the elements of stck except for the top element.
 */
...
/**
 * Pretty-prints the contents of a stack.
